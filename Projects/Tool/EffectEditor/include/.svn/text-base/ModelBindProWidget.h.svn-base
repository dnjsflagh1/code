#ifndef __MODEL_BIND_PROPERTY_WIDGET_H__
#define __MODEL_BIND_PROPERTY_WIDGET_H__
...
class ModelBindProWidget : public QWidget
{
	Q_OBJECT
public:
	ModelBindProWidget(QWidget *parent = 0, Qt::WFlags flags = 0);
	virtual ~ModelBindProWidget();
