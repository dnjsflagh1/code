#ifndef __PU_START_PRO_WIDGET_H__
#define __PU_START_PRO_WIDGET_H__
...
class PUStartProWidget : public QWidget
{
	Q_OBJECT
public:
	PUStartProWidget(QWidget *parent = 0, Qt::WFlags flags = 0);
	virtual ~PUStartProWidget();
