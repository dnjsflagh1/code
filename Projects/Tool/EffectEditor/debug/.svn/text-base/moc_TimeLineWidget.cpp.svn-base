...
**
** Created: Mon Nov 19 10:58:26 2012
...
static const char qt_meta_stringdata_TimeLineWidget[] = {
    "TimeLineWidget\0"
};

const QMetaObject TimeLineWidget::staticMetaObject = {
    { &QDockWidget::staticMetaObject, qt_meta_stringdata_TimeLineWidget,
      qt_meta_data_TimeLineWidget, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &TimeLineWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TimeLineWidget))
