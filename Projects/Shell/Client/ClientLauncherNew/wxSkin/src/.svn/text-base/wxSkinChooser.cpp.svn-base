...
:wxDialog(parent, -1, wxT("Choose a skin"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER)
{
    ...
    panelSizer->Add(txtComment, 1, wxALL|wxEXPAND|wxADJUST_MINSIZE, 5);
    panelSizer->Add(static_line_2, 0, wxEXPAND, 0);
    panelSizer->Add(lbAuthor, 0, wxALL|wxADJUST_MINSIZE, 5);
    ...
    buttonSizer->Add(btnSelect, 0, wxRIGHT|wxADJUST_MINSIZE, 10);
    buttonSizer->Add(btnCancel, 0, wxADJUST_MINSIZE, 0);
