...
private:
	...
	bool m_drawImg;
	wxImage m_customImg;
	wxPoint m_customPoint;
	wxSize m_customSize;
	wxImage m_customImg1;
	wxPoint m_customPoint1;
	wxSize m_customSize1;
...
public:
	...
	/// 绘制图片
	void DrawImage(wxSize &csize);
	void SetSubImg(wxImage &img, wxPoint &point);
	void SetMainImg(wxImage &img, wxPoint &point);
