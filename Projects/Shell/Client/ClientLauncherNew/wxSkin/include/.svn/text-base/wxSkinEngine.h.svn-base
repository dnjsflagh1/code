...
//stateFlag = 0:normal, stateFlag = 1:over, stateFlag = 2:down, stateFlag = 3:dis
...
public:
	...
	*/
	...
	//@{{ add by ken
	wxSkinEngine();		// private member.
	bool Load(const wxString& file, const wxString& subFile);
	//}}@ add by ken 
