...
namespace MG
{
    ...
    //---------------------------------------------------------------------
    void TerrainMaterialGeneratorA::SM2Profile::respondOptions(Bool immediately, Bool isSimple)
    {
    ...
    //---------------------------------------------------------------------
    void TerrainMaterialGeneratorA::SM2Profile::requestOptions(TerrainGroundTileRender* tileRender)
    {
    ...
    //---------------------------------------------------------------------
    uint8 TerrainMaterialGeneratorA::SM2Profile::getMaxLayers(TerrainGroundTileRender* tileRender) const
    {
    ...
    //---------------------------------------------------------------------
    MaterialPtr TerrainMaterialGeneratorA::SM2Profile::generate(TerrainGroundTileRender* tileRender)
    {
    ...
    //---------------------------------------------------------------------
    void TerrainMaterialGeneratorA::SM2Profile::updateParams(const MaterialPtr& mat, TerrainGroundTileRender* tileRender)
    {
        TerrainBBGroundTileRender* bbTile = (TerrainBBGroundTileRender*)tileRender;
    ...
    //---------------------------------------------------------------------
    void TerrainMaterialGeneratorA::SM2Profile::addFixedTechnique(const MaterialPtr& mat, TerrainBBGroundTileRender* tileRender, TechniqueType tt)
    {
    ...
    //---------------------------------------------------------------------
    void TerrainMaterialGeneratorA::SM2Profile::setTextureilter(TextureUnitState* tu)
    {
        IDisplay* display = EngineMain::getInstance().display();
    ...
    //---------------------------------------------------------------------
    void TerrainMaterialGeneratorA::SM2Profile::addWireFrameTechnique(
    ...
    //---------------------------------------------------------------------
    void TerrainMaterialGeneratorA::SM2Profile::addNormalTechnique(
        const MaterialPtr& mat, TerrainBBGroundTileRender* tileRender, TechniqueType tt)
    {
    ...
    //---------------------------------------------------------------------
    bool TerrainMaterialGeneratorA::SM2Profile::isShadowingEnabled(TechniqueType tt, TerrainBBGroundTileRender* tileRender) const
    {
    ...
    //---------------------------------------------------------------------
    String TerrainMaterialGeneratorA::SM2Profile::ShaderHelper::getRGBAChannel(uint idx)
    {
        uint rem = idx % 4;
        switch(rem)
        {
    ...
    //---------------------------------------------------------------------
    String TerrainMaterialGeneratorA::SM2Profile::ShaderHelper::getXYZWChannel(uint idx)
    {
        uint rem = idx % 4;
        switch(rem)
        {
