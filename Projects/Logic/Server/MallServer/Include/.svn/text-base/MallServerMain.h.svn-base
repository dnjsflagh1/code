...
/******************************************************************************/
#ifndef _MALL_SERVERMAIN_H_
#define _MALL_SERVERMAIN_H_
/******************************************************************************/
#include "Singleton.h"
...
namespace MG
{
	...
	//登入服务器管理
	/******************************************************************************/
	class MallServerMain : public IServerDllInterface
	{
	public:
		SINGLETON_INSTANCE(MallServerMain);
		MallServerMain();
		virtual ~MallServerMain();
