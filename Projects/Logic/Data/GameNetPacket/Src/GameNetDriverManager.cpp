...
namespace MG
{
    ...
    void GameNetDriverManager::startThreadAutoHandle()
    {
        ...
        {
            mL2NThreadHandles.create(checkAndUpdateL2NEvents,this,"checkAndUpdateL2NEvents");
        }
  
        if ( mN2LThreadHandles.isRun() == false )
        {
            mN2LThreadHandles.create(checkAndUpdateN2LEvents,this,"checkAndUpdateL2NEvents");
        }
