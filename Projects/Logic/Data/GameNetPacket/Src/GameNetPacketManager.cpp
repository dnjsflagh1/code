...
namespace MG
{
    ...
    void GameNetPacketManager::startThreadAutoHandle()
    {
        ...
        if ( mThreadAutoHandleForAllDriver )
        {
            ...
            {
                mL2NThreadHandlesForAllDriver.create(checkAndUpdateL2NEventsFromAllDriver,this,"checkAndUpdateL2NEventsFromAllDriver");
            }

            if ( mN2LThreadHandlesForAllDriver.isRun() == false )
            {
                mN2LThreadHandlesForAllDriver.create(checkAndUpdateN2LEventsFromAllDriver,this,"checkAndUpdateN2LEventsFromAllDriver");
            }
        }else
        {
