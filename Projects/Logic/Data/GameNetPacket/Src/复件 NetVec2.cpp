...
namespace MG
{
	...
	NetVec2::NetVec2( Vec2& vec2 )
	{
		...
		{
			mData.mX = vec2.x;
			scrapX = ((vec2.x - mData.mX )+ 0.05f) * 10;
		}
		else
		{
			mData.mX = -vec2.x;
		...
		{
			mData.mY = vec2.y;
			scrapY = ((vec2.y - mData.mY )+ 0.05f) * 10;
		}
		else
		{
			mData.mY = -vec2.y;
	...
	NetVec2::NetVec2( Vec3& vec3 )
	{
		...
		{
			mData.mX = vec3.x;
			scrapX = ((vec3.x - mData.mX )+ 0.05f) * 10;
		}
		else
		{
			mData.mX = -vec3.x;
		...
		{
			mData.mY = vec3.z;
			scrapY = ((vec3.z - mData.mY )+ 0.05f) * 10;
		}
		else
		{
			mData.mY = -vec3.z;
