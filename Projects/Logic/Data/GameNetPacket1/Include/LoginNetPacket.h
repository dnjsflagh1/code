...
#pragma pack (1)
	...
	struct PT_LOGIN_F2C_CLAN_LIST_DATA
	{
		UInt nCount;
		PT_LOGIN_F2C_SIMPLECLANDATABASE clanDatabase[1]; 
	};
	struct PT_LOGIN_F2C_CLAN_LIST_DATA_INFO
	{
		static const Int elmentSize = sizeof (PT_LOGIN_F2C_SIMPLECLANDATABASE);
		static const Int headSize   = sizeof (PT_LOGIN_F2C_CLAN_LIST_DATA) - elmentSize;
		static  Int dataSize(PT_LOGIN_F2C_CLAN_LIST_DATA* data)
		{
			return headSize + data->nCount * elmentSize;
		}
	};
	class PT_LOGIN_F2C_CLAN_LIST_DATA_DESCRIBE : public GameNetPacketDataDescribe
	{
	public:
		PT_LOGIN_F2C_CLAN_LIST_DATA_DESCRIBE()
			:GameNetPacketDataDescribe()
		{
			mChannel                            =   GNPC_LOGIN;
			mType                               =   PT_LOGIN_F2C_CLAN_LIST;
			//mBaseDataSize                       =   PT_LOGIN_F2C_CLAN_LIST_DATA_INFO::dataSize;
		...
		virtual Bool checkDataValid( GameNetPacketData* data, I32 dataLen )
		{
			...
			if ( data->type != mType )
				return false;
			if ( dataLen != PT_LOGIN_F2C_CLAN_LIST_DATA_INFO::dataSize((PT_LOGIN_F2C_CLAN_LIST_DATA*)data) )
				return false;
			return true;
		}
	};
    //**********************************************************************
	//@名字:        PT_LOGIN_F2C_OPEN_CLANCONTROLUI
	//@功能:		FrontServer通知客户端打开家族界面
	//@备注:        ???
	//**********************************************************************/
    ...
    {
        static const Int dataSize   = sizeof (PT_LOGIN_F2C_OPEN_CLANCONTROLUI_DATA);
    };
	class PT_LOGIN_F2C_OPEN_CLANCONTROLUI_DATA_DESCRIBE : public GameNetPacketDataDescribe
	{
	public:
		PT_LOGIN_F2C_OPEN_CLANCONTROLUI_DATA_DESCRIBE()
			:GameNetPacketDataDescribe()
		{
			mChannel                            =   GNPC_LOGIN;
			mType                               =   PT_LOGIN_F2C_OPEN_CLANCONTROLUI;
			mBaseDataSize                       =   PT_LOGIN_F2C_OPEN_CLANCONTROLUI_DATA_INFO::dataSize;
    ...
    //**********************************************************************
	//@名字:        PT_LOGIN_C2F_SELECT_CLAN
	//@功能:		Client发送客户端选择家族到FrontServer
	//@备注:        ???
	//**********************************************************************/
	...
	class PT_LOGIN_C2F_SELECT_CLAN_DATA_DESCRIBE : public GameNetPacketDataDescribe
	{
	public:
		PT_LOGIN_C2F_SELECT_CLAN_DATA_DESCRIBE()
			:GameNetPacketDataDescribe()
		{
			mChannel                            =   GNPC_LOGIN;
			mType                               =   PT_LOGIN_C2F_SELECT_CLAN;
			mBaseDataSize                       =   PT_LOGIN_C2F_SELECT_CLAN_DATA_INFO::dataSize;
    ...
    //**********************************************************************
	//@名字:        PT_LOGIN_F2C_SELECT_CLAN_RESULT
	//@功能:		FrontServer返回家族选择结果给Client
	//@备注:        ???
	//**********************************************************************/
	...
	class PT_LOGIN_F2C_SELECT_CLAN_RESULT_DATA_DESCRIBE : public GameNetPacketDataDescribe
	{
	public:
		PT_LOGIN_F2C_SELECT_CLAN_RESULT_DATA_DESCRIBE()
			:GameNetPacketDataDescribe()
		{
			mChannel                            =   GNPC_LOGIN;
			mType                               =   PT_LOGIN_F2C_SELECT_CLAN_RESULT;
			mBaseDataSize                       =   PT_LOGIN_F2C_SELECT_CLAN_RESULT_DATA_INFO::dataSize;
