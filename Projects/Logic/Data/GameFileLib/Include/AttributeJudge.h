//////////////////////////////////////////////////////////////
//******************************************************************************************
#ifndef _H_ATTRIBUTEJUDGE_
#define _H_ATTRIBUTEJUDGE_
//******************************************************************************************
...
namespace MG
{
	...
	{
		U32					AbilityJudgeId;
		ABILITYJUDGE_TYPE	AbilityJudgeType; //通用非战斗属性附加的id
	...
	public:
		AttributeJudge(){;}
		~AttributeJudge();
		SINGLETON_INSTANCE(AttributeJudge);

	public:
		// MG_CN_MODIFY
		//加载AttributeJudge.csv表
		Bool						load(Str16 fileName, IMGExternalPackManager* packManager = NULL);
		//根据ID获得附加属性表
		const AttributeJudgeInfo*	getAttributeJudgeInfo(U32 id);

	protected:
		void						clear();

	private:
		std::map<UInt, AttributeJudgeInfo*>  mMapAttributeJudgeInfo;
