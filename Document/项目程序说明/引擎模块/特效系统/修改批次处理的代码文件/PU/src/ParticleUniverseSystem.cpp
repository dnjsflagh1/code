...
#ifndef CN_MODIFY
		technique->setRenderer(ParticleRendererManager::getSingletonPtr()->createRenderer(
			technique, technique->getParentSystem()->getRenderGroupID(), "Billboard"));
#endif
...
#ifdef CN_MODIFY
	void ParticleSystem::setRenderGroupID( uint8 groupid )
	{
		mRenderGroupID = groupid;
	}

	Ogre::uint8 ParticleSystem::getRenderGroupID()
	{
