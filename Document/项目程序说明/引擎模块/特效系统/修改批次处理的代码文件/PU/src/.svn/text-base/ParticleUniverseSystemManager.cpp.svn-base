...
template<> ParticleUniverse::ParticleSystemManager* ParticleUniverse::Singleton<ParticleUniverse::ParticleSystemManager>::ms_Singleton = 0;
...
#else
		ParticleRenderer* clonedRenderer = ParticleRendererManager::getSingletonPtr()->createRenderer(
			renderer->getParentTechnique(), renderer->getParentTechnique()->getParentSystem()->getRenderGroupID(),
...
#ifdef CN_MODIFY
		sys->setTemplateName(templateName);
